...
> *[Espacio reservado para la redacción personal de Kevin Gallardo sobre los desafíos del desarrollo frontend, la colaboración mediante branches y la experiencia gestionando el hotfix en Git].*

### 2. Reflexión de Alexsander Rosales (Backend Developer)
> *[Espacio reservado para la redacción personal de Alexsander Rosales sobre la construcción del microservicio, la integración de endpoints y el flujo de pull requests en develop].*

### 3. Reflexión de Paulo Rivas (DevOps Engineer)
> *[Espacio reservado para la redacción personal de Paulo Rivas sobre el diseño de la gobernanza en GitFlow, la configuración del pipeline en GitHub Actions y la automatización CI en la nube].*
